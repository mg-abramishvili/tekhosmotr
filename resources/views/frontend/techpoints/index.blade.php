    ...
    <script>
        ymaps.ready(function () {
            var myMap = new ymaps.Map('map', {
                ...
                @elseif($city == 'iglin')
                center: [54.83419335793247,56.49791700390626],
                @elseif($city == 'karmas')
                center: [54.36825271021719,56.144289207031164],
                @elseif($city == 'kuyur')
                center: [52.65503886564177,55.65516400000001],
                @elseif($city == 'mechet')
                center: [55.894083585773444,58.36388549999999],
                @elseif($city == 'mishk')
                center: [55.541508948098006,55.92203012500004],
                @elseif($city == 'sterl')
                center: [53.43311554236234,55.21783662499998],
                @elseif($city == 'haib')
                center: [52.05002124193424,58.00674649999995],
                @elseif($city == 'chekm')
                center: [55.134581329365055,54.64389174609371],
                @elseif($city == 'sharan')
                center: [54.84002416051455,54.00863941015623],
                @else
                center: [54.753185705515016,55.98859607958987],
                @endif
                zoom: 11
